    ...
    <div id="main-container">
        <div id="login-wrapper" class="form-container">
            <form method="post" action="register.php">
                ...
                <button type="submit" name="loginBtn" id="loginBtn">Login</button> <!-- Added name attribute -->
        ...
        <div id="sign-up-wrapper" class="form-container">
            <form method="post" action="register.php">
                ...
                <button type="submit" name="signUpBtn" id="signUpBtn">Sign-Up</button> <!-- Added name attribute -->
